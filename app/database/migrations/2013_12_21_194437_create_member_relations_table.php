...
class CreateMemberRelationsTable extends Migration {
	...
	public function up()
	{
		...
		Schema::create("member_relations", function($table){
			...
			$table->enum("relationship", array("father", "stepfather", "father-in-law", "mother", "stepmother", "mother-in-law", "sister", "brother", "son", "stepson", "daughter", "stepdaughter", "son-in-law", "daughter-in-law"))->nullable();
